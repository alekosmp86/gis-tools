...
export const ShapefileUploader: React.FC<ShapefileUploaderProps> = ({
  ...
  const [data, setData] = useState<ParsedShapefileData | null>(loadedData);
        ...
        <div className={styles.loadedCard}>
            ...
            <div className={styles.fileMeta}>
              ...
              <div>
                ...
                <div className={styles.fileSub}>
                  Tamaño: {formatSize(data.fileSize)} &bull; Tipo: {data.geometryType}
                </div>
              </div>
            </div>
          ...
          <div className={styles.metaRow}>
            ...
            <div className={styles.metaItem}>
              ...
              <span className={styles.metaValue}>{data.geometryType}</span>
            </div>
          </div>
